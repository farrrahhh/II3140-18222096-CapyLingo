...
app.get("/", (req, res) => {
  res.send('Welcome to the Quiz API. Link to GitHub: <a href="https://github.com/farrrahhh/II3140-18222096-CapyLingo">https://github.com/farrrahhh/II3140-18222096-CapyLingo</a>');
});
